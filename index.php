    ...
    <div class="row"> 
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>  At Edurent, excellence is our standard. We take pride in being consistently top-rated in the real estate industry.
                                             Our commitment to delivering exceptional service and results has earned us the trust and satisfaction of our clients. 
                                             When you choose us, you're choosing the best.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>With years of experience in the real estate market, we bring unparalleled expertise to the table. 
                                            Our team has navigated through diverse market trends and challenges, honing our skills to perfection. 
                                            This experience ensures that you receive the highest quality service, tailored to meet your unique needs.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team comprises seasoned real estate agents who are not just professionals but passionate advocates for your property goals. 
                                          Their wealth of experience allows them to navigate the complexities of the market with ease, providing you with insights and guidance that make your real estate journey smooth and successful.</p>
									</div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">How we Work</h2>
                        </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Your real estate journey begins with a personalized discussion. We take the time to understand your unique goals, preferences, and expectations.
                    ...
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once we have a clear understanding of your requirements, our team conducts a thorough review of all relevant documents and details.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Armed with comprehensive insights from our discussions and file reviews, we embark on the journey to acquire the perfect property or successfully market yours. </p>
                        </div>
                    </div>
                </div>
            </div>
